...
if (command === 'check') {
  ...
  if (sdkSnapshot) {
    Object.assign(report, {
      ...
      traceFormatVersion: 1,
      supportedCapabilities: ['check', 'executionSnapshot', 'eventStream', 'trace'],
      execution_snapshot: '{"format_version":1,"root":"fixture.nika","digest":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","units":[{"path":"fixture.nika","kind":0,"digest":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","bytes_hex":"00"}]}',
    });
  }
